...
:::details
### How long does it take to make my wallet fully private?

Dependeing on multiple factors, like the `coinjoin strategy` and the amount of bitcoin, it can take from a couple hours to multiple days or more.
:::
